...
public class D extends RoadModel{
	...
	public void initialThis() {
		double trust=0.0009; //the measurement error standard deviation put on the agents that cannot recognize the low-performance sensors		
		if (trueSolution.measurePerturb){
